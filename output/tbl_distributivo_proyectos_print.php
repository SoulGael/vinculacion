...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_distributivo_proyectos_print";
...
$page_layouts["tbl_distributivo_proyectos_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tbl_distributivo_proyectos" );
