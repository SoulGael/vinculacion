...
require_once("include/tbl_facultad_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_facultad_edit";
...
$page_layouts["tbl_facultad_edit"] = $layout;
...
$keys = array();
$keys["id_facultad"] = postvalue("editid1");
