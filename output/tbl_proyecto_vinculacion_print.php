...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_proyecto_vinculacion_print";
...
$page_layouts["tbl_proyecto_vinculacion_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tbl_proyecto_vinculacion" );
