...
(function($) {
  $.widget("akottr.dragtable", {
    ...
    _generateSortable: function(e) {
      ...
      var heightArr = [];
      this.originalTable.el.find('tr.bs-gridrow').slice(0, this.options.maxMovingRows).each(function(i, v) {
        // row attributes
      ...
      thtb.find('> tr > th').each(function(i, v) {
        ...
        if (_this.options.maxMovingRows > 1) {
          row = row.add(thtb.find('> tr.bs-gridrow > td:nth-child(' + (i + 1) + ')').slice(0, _this.options.maxMovingRows - 1));
        }
        row.each(function(j) {
