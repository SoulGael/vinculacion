...
function checkTableName($shortTName, $type=false)
{
	...
	if ("tbl_ciudad" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tbl_carrera" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tbl_extension" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tbl_facultad" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tbl_modalidad" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tbl_periodo" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tbl_rol" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
...
function GetUserPermissions($table="")
{
	...
	if($table=="tbl_carrera")
	{
		$permissions =  "ADESPIM";
	}
	if($table=="tbl_extension")
	{
		$permissions =  "ADESPIM";
	}
	if($table=="tbl_facultad")
	{
		$permissions =  "ADESPIM";
	}
	if($table=="tbl_modalidad")
	{
		$permissions =  "ADESPIM";
	}
	if($table=="tbl_periodo")
	{
		$permissions =  "ADESPIM";
	}
	if($table=="tbl_rol")
