...
Runner.controls.MapManager = Runner.extend( Runner.emptyFn, {
	...
	constructor: function( cfg ) {
		...
		var hostPage = Runner.pages.PageManager.getAt( this.tName, this.id );
		this.showViewInPopup = hostPage && hostPage.showViewInPopup();
		this.showEditInPopup = hostPage && hostPage.showEditInPopup();
