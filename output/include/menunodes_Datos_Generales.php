...
function getMenuNodes_Datos_Generales($menuNodesObject)
{
	// create menu nodes arr
	$menuNodesObject->menuNodes["Datos_Generales"] = array();
	...
	$menuNodesObject->menuNodes["Datos_Generales"][] = $menuNode;
	$menuNode = array();
	$menuNode["id"] = "2";
	$menuNode["name"] = "";
	$menuNode["href"] = "mypage.htm";
