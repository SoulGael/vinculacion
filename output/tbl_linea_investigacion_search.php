...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_linea_investigacion_search";
...
$page_layouts["tbl_linea_investigacion_search"] = $layout;
...
$params['shortTableName'] = 'tbl_linea_investigacion';
