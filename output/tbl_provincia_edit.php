...
require_once("include/tbl_provincia_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_provincia_edit";
...
$page_layouts["tbl_provincia_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_provincia_list";
...
$page_layouts["tbl_provincia_list"] = $layout;
...
$keys = array();
$keys["id_provincia"] = postvalue("editid1");
