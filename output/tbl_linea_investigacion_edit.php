...
require_once("include/tbl_linea_investigacion_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_linea_investigacion_edit";
...
$page_layouts["tbl_linea_investigacion_edit"] = $layout;
...
$keys = array();
$keys["id_linea_investigacion"] = postvalue("editid1");
