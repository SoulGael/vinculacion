...
require_once("include/tbl_rol_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_rol_edit";
...
$page_layouts["tbl_rol_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_rol_list";
...
$page_layouts["tbl_rol_list"] = $layout;
