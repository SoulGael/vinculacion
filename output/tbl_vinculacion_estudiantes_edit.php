...
require_once("include/tbl_vinculacion_estudiantes_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_vinculacion_estudiantes_edit";
...
$page_layouts["tbl_vinculacion_estudiantes_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_vinculacion_estudiantes_list";
...
$page_layouts["tbl_vinculacion_estudiantes_list"] = $layout;
...
$keys = array();
$keys["id_vinculacion_estudiantes"] = postvalue("editid1");
