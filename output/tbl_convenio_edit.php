...
require_once("include/tbl_convenio_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_convenio_edit";
...
$page_layouts["tbl_convenio_edit"] = $layout;
...
$keys = array();
$keys["id_convenio"] = postvalue("editid1");
