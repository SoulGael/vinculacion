...
require_once("include/tbl_programa_vinculacion_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_programa_vinculacion_edit";
...
$page_layouts["tbl_programa_vinculacion_edit"] = $layout;
...
$keys = array();
$keys["id_programa_vinculacion"] = postvalue("editid1");
