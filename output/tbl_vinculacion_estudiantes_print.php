...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_vinculacion_estudiantes_print";
...
$page_layouts["tbl_vinculacion_estudiantes_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tbl_vinculacion_estudiantes" );
