...
require_once("include/tbl_ciudad_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_ciudad_edit";
...
$page_layouts["tbl_ciudad_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_ciudad_list";
...
$page_layouts["tbl_ciudad_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_extension_list";
$layout->blocks["center"] = array();
$layout->containers["gridcontrols"] = array();
$layout->container_properties["gridcontrols"] = array(  );
$layout->containers["gridcontrols"][] = array("name"=>"wrapper",
...
$layout->blocks["topmiddle"][] = "masterinfo";
$page_layouts["tbl_extension_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_institucion_list";
$layout->blocks["center"] = array();
$layout->containers["gridcontrols"] = array();
$layout->container_properties["gridcontrols"] = array(  );
$layout->containers["gridcontrols"][] = array("name"=>"wrapper",
...
$layout->blocks["topmiddle"][] = "masterinfo";
$page_layouts["tbl_institucion_list"] = $layout;
...
$keys = array();
$keys["id_ciudad"] = postvalue("editid1");
