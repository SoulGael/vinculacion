...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_programa_vinculacion_print";
...
$page_layouts["tbl_programa_vinculacion_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tbl_programa_vinculacion" );
