...
require_once("include/tbl_proyecto_vinculacion_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_proyecto_vinculacion_edit";
...
$page_layouts["tbl_proyecto_vinculacion_edit"] = $layout;
...
$keys = array();
$keys["id_proyecto_vinculacion"] = postvalue("editid1");
