...
class ConnectionManager
{
	...
	{
		return $this->byId( "vinculacion_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "vinculacion_at_localhost";
		$data["connName"] = "vinculacion at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;vinculacion;;1"; //currently unused

		$this->_connectionsIdByName["vinculacion at localhost"] = "vinculacion_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "vinculacion";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=vinculacion;OPTION=3";
		// encription set
		...
		$connectionsData["vinculacion_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["tbl_ciudad"] = "vinculacion_at_localhost";
		$connectionsIds["tbl_carrera"] = "vinculacion_at_localhost";
		$connectionsIds["tbl_extension"] = "vinculacion_at_localhost";
		$connectionsIds["tbl_facultad"] = "vinculacion_at_localhost";
		$connectionsIds["tbl_modalidad"] = "vinculacion_at_localhost";
