...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_rol_print";
...
$page_layouts["tbl_rol_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tbl_rol" );
