...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_modalidad_print";
...
$page_layouts["tbl_modalidad_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tbl_modalidad" );
