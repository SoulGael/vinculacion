...
require_once("include/tbl_persona_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "yeti";
		$layout->customCssPageName = "tbl_persona_edit";
...
$page_layouts["tbl_persona_edit"] = $layout;
...
$keys = array();
$keys["id_persona"] = postvalue("editid1");
