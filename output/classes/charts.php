...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("tbl_ciudad" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_carrera" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_extension" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_facultad" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_modalidad" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_periodo" == $this->chrt_array['tables'][0])
			return true;
		if("tbl_rol" == $this->chrt_array['tables'][0])
			return true;
