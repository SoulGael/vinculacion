...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "tbl_ciudad" ] = array( "url" => "tbl_ciudad", "type" => 0 );
	$projectEntitiesReverse[ "tbl_ciudad" ] = "tbl_ciudad";
	$projectEntities[ "tbl_carrera" ] = array( "url" => "tbl_carrera", "type" => 0 );
	$projectEntitiesReverse[ "tbl_carrera" ] = "tbl_carrera";
	$projectEntities[ "tbl_extension" ] = array( "url" => "tbl_extension", "type" => 0 );
	$projectEntitiesReverse[ "tbl_extension" ] = "tbl_extension";
	$projectEntities[ "tbl_facultad" ] = array( "url" => "tbl_facultad", "type" => 0 );
	$projectEntitiesReverse[ "tbl_facultad" ] = "tbl_facultad";
	$projectEntities[ "tbl_modalidad" ] = array( "url" => "tbl_modalidad", "type" => 0 );
	$projectEntitiesReverse[ "tbl_modalidad" ] = "tbl_modalidad";
	$projectEntities[ "tbl_periodo" ] = array( "url" => "tbl_periodo", "type" => 0 );
	$projectEntitiesReverse[ "tbl_periodo" ] = "tbl_periodo";
	$projectEntities[ "tbl_rol" ] = array( "url" => "tbl_rol", "type" => 0 );
	$projectEntitiesReverse[ "tbl_rol" ] = "tbl_rol";
	$projectEntities[ "tbl_provincia" ] = array( "url" => "tbl_provincia", "type" => 0 );
